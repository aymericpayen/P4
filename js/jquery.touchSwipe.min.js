 ...
 */ !(function (e) {
  ...
  function t(n, t) {
    function P(n) {
      if (
        !(
          !(!0 !== eE.data(m + "_intouch")) ||
          e(n.target).closest(t.excludedElements, eE).length > 0
        )
      ) {
        ...
        if (
          ...
          return (
            ...
            !c || ex === t.fingers || t.fingers === w || C()
              ? ((eO = el()),
                2 == ex &&
                  (J(1, c[1]), (e$ = ev = er(eS[0].start, eS[1].start))),
            ...
            !1 === u
              ...
              : (t.hold &&
                  (ek = setTimeout(
                    e.proxy(function () {
                      eE.trigger("hold", [a.target]),
                        t.hold && (u = t.hold.call(eE, a, a.target));
                    }, this),
                    t.longTapThreshold
                  )),
                B(!0),
        ...
        if (
          ...
          2 == ex &&
            (0 == e$
              ...
              : (K(d[1]),
                (ev = er(eS[0].end, eS[1].end)),
                (e_ = (eS[0].end, eS[1].end, ew < 1 ? u : a))),
          ...
          if (
            ...
            (eh =
              ...
              (O = _.end),
              Math.round(
                Math.sqrt(Math.pow(O.x - S.x, 2) + Math.pow(O.y - S.y, 2))
              ))),
            (ed = et()),
            (m = ef),
            (P = eh),
            ...
            if (t.triggerOnTouchLeave) {
              ...
              x =
                ((R = _.end),
                (k = I),
                R.x > k.left && R.x < k.right && R.y > k.top && R.y < k.bottom);
            }
            !t.triggerOnTouchEnd && x
              ? (ey = U(b))
              : t.triggerOnTouchLeave && !x && (ey = U(E)),
              (ey != y && ey != E) || A(p, ey);
          }
        } else A(p, (ey = y));
        !1 === h && A(p, (ey = y));
    ...
    function A(e, n) {
      ...
      return (
        ...
        z() && W() && !1 !== r
          ...
          ? (r = M(e, n, d))
          : !((1 === ex || !x) && (isNaN(eh) || eh < t.threshold)) ||
            !V() ||
            !1 === r ||
            (r = M(e, n, f)),
        n === y && R(e),
          ...
          switch (ef) {
            case r:
              eE.trigger("swipeLeft", [ef, eh, ed, ex, eS, eg]),
                t.swipeLeft &&
                  ($ = t.swipeLeft.call(eE, n, ef, eh, ed, ex, eS, eg));
              break;
            case i:
              eE.trigger("swipeRight", [ef, eh, ed, ex, eS, eg]),
                t.swipeRight &&
                  ($ = t.swipeRight.call(eE, n, ef, eh, ed, ex, eS, eg));
              break;
            case l:
              eE.trigger("swipeUp", [ef, eh, ed, ex, eS, eg]),
                t.swipeUp &&
                  ($ = t.swipeUp.call(eE, n, ef, eh, ed, ex, eS, eg));
              break;
            case o:
              eE.trigger("swipeDown", [ef, eh, ed, ex, eS, eg]),
                t.swipeDown &&
                  ($ = t.swipeDown.call(eE, n, ef, eh, ed, ex, eS, eg));
          }
        }
      }
      if (c == h) {
        if (
          (eE.trigger("pinchStatus", [
            s,
            e_ || null,
            eT || 0,
            ed || 0,
    ...
    function ei(e, n) {
      ...
      var t,
        ...
        f =
          ...
          (c = n),
          (p = u.x - c.x),
          (h = Math.round((180 * Math.atan2(c.y - u.y, p)) / Math.PI)) < 0 &&
            (h = 360 - Math.abs(h)),
          h);
      return f <= 45 && f >= 0
        ? r
