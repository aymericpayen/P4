  ...
  (function (t) {
    ...
    (t.fn.alert = function e(o) {
      return this.each(function () {
        var e = t(this),
          s = e.data("bs.alert");
        s || e.data("bs.alert", (s = new i(this))),
          "string" == typeof o && s[o].call(e);
      });
    }),
  ...
  (function (t) {
    ...
    function e(e) {
      return this.each(function () {
        var o = t(this),
          s = o.data("bs.button");
        s || o.data("bs.button", (s = new i(this, "object" == typeof e && e))),
  ...
  (function (t) {
    ...
    (t.fn.dropdown = function e(i) {
      return this.each(function () {
        ...
        o || e.data("bs.dropdown", (o = new n(this))),
          "string" == typeof i && o[i].call(e);
      });
    }),
  ...
  (function (t) {
    ...
    (e.VERSION = "3.3.5"),
      ...
      (e.prototype.applyPlacement = function (e, i) {
        ...
        o.offset(e),
          this.replaceArrow(c, o[0][p ? "offsetWidth" : "offsetHeight"], p);
      }),
    ...
    (t.fn.tooltip = function i(o) {
      return this.each(function () {
        var i = t(this),
          s = i.data("bs.tooltip");
        (s || !/destroy|hide/.test(o)) &&
          (s ||
            i.data("bs.tooltip", (s = new e(this, "object" == typeof o && o))),
          "string" == typeof o && s[o]());
      });
    }),
  ...
  (function (t) {
    ...
    (t.fn.popover = function i(o) {
      return this.each(function () {
        ...
        (s || !/destroy|hide/.test(o)) &&
          (s ||
            i.data("bs.popover", (s = new e(this, "object" == typeof o && o))),
          "string" == typeof o && s[o]());
      });
    }),
  ...
  (function (t) {
    ...
    function i(i) {
      return this.each(function () {
        ...
        s ||
          o.data("bs.scrollspy", (s = new e(this, "object" == typeof i && i))),
          "string" == typeof i && s[i]();
      });
    }
    (e.VERSION = "3.3.5"),
  ...
  (function (t) {
    ...
    function e(e) {
      return this.each(function () {
        var o = t(this),
          s = o.data("bs.affix");
        s || o.data("bs.affix", (s = new i(this, "object" == typeof e && e))),
          "string" == typeof e && s[e]();
      });
    }
    var i = function (e, o) {
